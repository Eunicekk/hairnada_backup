...
public class PageAdminListVo {
    ...
    private CriteriaAdminList criteria;

    public PageAdminListVo() {}

    public PageAdminListVo(CriteriaAdminList criteria, int total){
        this(criteria, total, 5); // 페이지 카운트를 별도로 받지 않으면 세트당 5개로 고정
    }

    public PageAdminListVo(CriteriaAdminList criteria,  int total, int pageCount){
