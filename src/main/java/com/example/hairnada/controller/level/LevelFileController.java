...
import com.example.hairnada.service.level.LevelFileService;
...
@RestController
@RequestMapping("/levelFile/*")
@RequiredArgsConstructor
public class LevelFileController {
    private final LevelFileService levelFileService;
    @Value("${file.dir}")
    private String fileDir;

    @GetMapping("/tierImg")
    public LevelFileDto imgList(Long levelNumber){return levelFileService.findList(levelNumber);}
