...
$('.search').on('click', function (){
  ...
  if(storeTitle == null){
    ...
    $.ajax({
      ...
      success: function (storeTitle) {
        console.log('Received storeTitle:',storeTitle);
        $('.cl').html('');
    ...
    <ul class="list-ul">
                  ...
                  <li class="list-li">
                    ...
                    <div class="product-information">
                      <p class="product-title">${storeTitle[i].storeTitle}</p>
                      <p class="product-category">${storeTitle[i].storeCategoryName}</p>
                      <p class="product-price">
                        ₩ <span class="price">${storeTitle[i].storePrice}</span>
                      </p>
                    </div>
                  </li>
                </ul>
